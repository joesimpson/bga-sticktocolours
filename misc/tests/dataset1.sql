...
UPDATE `card` set card_location='hand', card_location_arg = :player1 WHERE card_type = 1 AND card_type_arg =1 order by card_id asc LIMIT 1 ;
UPDATE `card` set card_location='hand', card_location_arg = :player1 WHERE card_type = 1 AND card_type_arg =1 order by card_id DESC LIMIT 1 ;
...
-- give 2/3 JOKERs to test scoring jokers :
UPDATE `card` set card_location='hand', card_location_arg = :player1 WHERE card_type = 1 AND card_type_arg =10 ;
UPDATE `card` set card_location='hand', card_location_arg = :player1 WHERE card_type = 2 AND card_type_arg =10 ;


-- IF we have only 3 players :
-- UPDATE `card` set card_location_arg = :player1  WHERE card_location='hand' AND card_location_arg = :player4;
...
UPDATE global SET global_value='0' WHERE global_id='20';